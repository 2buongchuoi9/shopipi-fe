...
import ratingApi, { buildRatingTree, Rating as RatingType } from '@/http/ratingApi'
                    ...
                    <div key={star} className="flex items-center mb-2">
                        ...
                        <div className="w-40 h-2 bg-gray-300 mx-2 rounded">
                            <div
                                ...
                                style={{ width: `${(ratingsCount[star] / totalRating) * 100}%` }}
                            ></div>
                        </div>
                        <div className="w-6 text-right">{ratingsCount[star]}</div>
                    </div>
                ))}
            </div>
