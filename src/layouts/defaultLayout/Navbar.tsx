        ...
        <header className="w-full bg-white">
            <div className="flex flex-col md:flex-row flex-wrap justify-between bg-amazonclone text-black h-[60px] px-10 py-2">
                ...
                <div className="flex items-center space-x-4 md:space-x-0 md:mx-4">
                    ...
                    <div className="hidden md:flex md:items-center mb-2 hover:bg-gray-100 p-3 rounded-lg transition-all duration-300 ease-in-out">
                        <span className="ml-4 mt-0">
                            <MdOutlineCloudDownload size={25} className="text-blue-500" />
                        </span>
                        <div className="ml-3">
