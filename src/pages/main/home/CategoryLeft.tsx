...
const CategoryLeft = () => {
    return (
        <div className="w-[16rem] h-auto border bg-white p-8 rounded-lg mb-10">
            <div>
                ...
                {imageSrcs.map((image, index) => (
                    <Link
                        ...
                        key={index}
                        className="flex items-center py-2 px-2 space-x-2 hover:bg-gray-200 rounded-xl transition duration-300 ease-in-out"
                    >
                        <img
                            src={image.src}
                            alt={image.title}
